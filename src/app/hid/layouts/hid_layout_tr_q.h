...
#define HID_LAYOUT_TR_Q                                                                                       \
    {0, 0},                                  /* 0x00 NUL*/                                                    \
        ...
        {KEYBOARD_MODIFIER_LEFTSHIFT, 0x1F}, /* 0x22 " → Shift+2 (TR: " Shift+2'de)*/                         \
        ...
        {KEYBOARD_MODIFIER_RIGHTALT, 0x23},  /* 0x26 & → AltGr+6  (TR düzeni)*/                               \
        {KEYBOARD_MODIFIER_LEFTSHIFT, 0x23}, /* 0x27 ' → Shift+4 (TR: ' Shift+4'te değil, ayrı tuş)*/         \
        {KEYBOARD_MODIFIER_LEFTSHIFT, 0x26}, /* 0x28 ( → Shift+8 (TR: ( Shift+8)*/                            \
        {KEYBOARD_MODIFIER_LEFTSHIFT, 0x27}, /* 0x29 ) → Shift+9 (TR: ) Shift+9)*/                            \
        {KEYBOARD_MODIFIER_LEFTSHIFT, 0x25}, /* 0x2A * → Shift+**/                                            \
        {KEYBOARD_MODIFIER_LEFTSHIFT, 0x2E}, /* 0x2B + → Shift+=*/                                            \
        {0, 0x36},                           /* 0x2C ,*/                                                      \
        {0, 0x2D},                           /* 0x2D -*/                                                      \
        {0, 0x37},                           /* 0x2E .*/                                                      \
        {KEYBOARD_MODIFIER_LEFTSHIFT, 0x24}, /* 0x2F / → Shift+7 (TR: / Shift+7)*/                            \
        {0, 0x27},                           /* 0x30 0*/                                                      \
        {0, 0x1E},                           /* 0x31 1*/                                                      \
        {0, 0x1F},                           /* 0x32 2*/                                                      \
        {0, 0x20},                           /* 0x33 3*/                                                      \
        ...
        {0, 0x25},                           /* 0x38 8*/                                                      \
        {0, 0x26},                           /* 0x39 9*/                                                      \
        {KEYBOARD_MODIFIER_LEFTSHIFT, 0x33}, /* 0x3A : → Shift+;*/                                            \
        {0, 0x33},                           /* 0x3B ;*/                                                      \
        {0, 0x36},                           /* 0x3C < → , tuşu (TR: < virgül tuşunda)*/                      \
        {0, 0x2E},                           /* 0x3D =*/                                                      \
        {KEYBOARD_MODIFIER_LEFTSHIFT, 0x37}, /* 0x3E > → Shift+.*/                                            \
        ...
        {KEYBOARD_MODIFIER_RIGHTALT, 0x2F},  /* 0x5B [ → AltGr+[*/                                            \
        {KEYBOARD_MODIFIER_RIGHTALT, 0x2D},  /* 0x5C \ → AltGr+-*/                                            \
        {KEYBOARD_MODIFIER_RIGHTALT, 0x30},  /* 0x5D ] → AltGr+]*/                                            \
        {KEYBOARD_MODIFIER_RIGHTALT, 0x23},  /* 0x5E ^  (TR: AltGr+3 veya dead key — layout'a göre değişir)*/ \
        {KEYBOARD_MODIFIER_LEFTSHIFT, 0x2D}, /* 0x5F _  → Shift+-*/                                           \
        {0, 0x35},                           /* 0x60 `*/                                                      \
        {0, 0x04},                           /* 0x61 a*/                                                      \
        {0, 0x05},                           /* 0x62 b*/                                                      \
        {0, 0x06},                           /* 0x63 c*/                                                      \
        ...
        {0, 0x1C},                           /* 0x79 y*/                                                      \
        {0, 0x1D},                           /* 0x7A z*/                                                      \
        {KEYBOARD_MODIFIER_RIGHTALT, 0x2F},  /* 0x7B { → AltGr+[*/                                            \
        {KEYBOARD_MODIFIER_RIGHTALT, 0x31},  /* 0x7C | → AltGr+'\'*/                                          \
        {KEYBOARD_MODIFIER_RIGHTALT, 0x30},  /* 0x7D } → AltGr+]*/                                            \
        {0, 0},                              /* 0x7E ~  (TR'de direkt yok, dead key gerekir)*/                \
        {0, 0},                              /* 0x7F DEL*/\
