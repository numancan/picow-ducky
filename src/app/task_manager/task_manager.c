...
typedef struct {
    ...
    TaskHandle_t handle;
    bool notify_on_stop;  // If true, send notification instead of vTaskDelete
} task_config_t;

static task_config_t tasks[TASK_MANAGER_TASK_COUNT] = {
    [TASK_MANAGER_TASK_GUI] = {gui_task, "gui", 1024, tskIDLE_PRIORITY + 1, NULL, true},
    [TASK_MANAGER_TASK_INPUT] = {input_task, "input", 512, tskIDLE_PRIORITY + 2, NULL, true},
    [TASK_MANAGER_TASK_WEB_SERVER] = {web_server_task, "webserver", 1024, tskIDLE_PRIORITY + 1, NULL, true},
    [TASK_MANAGER_TASK_DUCKY] = {ducky_task, "ducky", 1024, tskIDLE_PRIORITY + 1, NULL, true},
    [TASK_MANAGER_TASK_USB_HID] = {usb_hid_task, "usb_hid", 1024, tskIDLE_PRIORITY + 3, NULL, false},
    [TASK_MANAGER_TASK_STATUS_LED] = {status_led_task, "status_led", 512, tskIDLE_PRIORITY + 3, NULL, false},
};
